...
public class SecurityConfig {
    ...
    public SecurityFilterChain configuracionCadenasFiltrosSeguridad(HttpSecurity http) throws Exception {
        http
                ...
                // OAuth2 Resource Server (Validación de JWT) -> Con convertidor de roles
    ...
    public org.springframework.security.oauth2.server.resource.authentication.JwtAuthenticationConverter jwtAuthenticationConverter() {
        ...
        // Azure AD usa el claim 'roles' por defecto
    ...
    public org.springframework.web.cors.CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedHeaders(java.util.List.of("Authorization", "Content-Type", "Accept", "X-Requested-With"));// headers explícitos para navegadores estrictos
